STAGES = [
	{'title': 'Stage 1: Structure of the Web',
		'lessons': [
	...
	{'title': 'Stage 2: Intro to Computer Science',
		'lessons': [
	...
	{'title': 'Stage 5: Where It Goes From Here',
		'lessons': [
			{'title': 'Lesson 5.1: Meet JavaScript',
			'concepts': [
				{'title': 'What is JavaScript?',
				'description': 'JavaScript is <em>the</em> language of the web. Injecting our webpages '
							   'with JavaScript allows us to add things like interactivity to our work.'},
				{'title': 'JSON',
				'description': 'JSON stands for <em>JavaScript Object Notation</em>. It is a popular '
							   'format for storing and transferring nested data. JSON linters allow '
							   'us to quickly and easily identify syntax errors in our JSON.'}
				]
			},
			{'title': 'Lesson 5.2: The Power of APIs',
			'concepts': [
				{'title': 'What are APIs?',
				'description': 'APIs are powerful tools for development. API stands for <em> Application '
							   'Programming Interface</em> and allow for simple interaction with other systems, '
							   'applications, libraries, and more. For example, in this lesson we used an API '
							   'to get the location of a user from their IP address.'}
				]
			},
			{'title': 'Lesson 5.3: Recursion and Parallel Computing',
			'concepts': [
				{'title': 'Recursion',
				'description': 'Recursion is a powerful and fundamental idea in computer science. '
							   'Recursion is when a computer program calls itself in its operation. '
							   'A classic example is factorial(n). It is important to remember that '
							   'a base case must be defined for recursion to terminate.'},
				{'title': 'Parallel Computing',
				'description': 'Processors can only execute a certain number of procedures in a time. '
							   'While we could increase this number, it prove to be very expensive. '
							   'Parallel computing addresses this dilemma by having multiple processors '
							   'running in parallel so that we can execute many procedures at once.'}
				]
			},
			{'title': 'Lesson 5.4: Solving Big Problems',
			'concepts': [
				{'title': 'Breaking Problems Down',
				'description': 'Tackling large problems can seem daunting but there are things we can '
							   'do to make it easier. We should begin by breaking our large problem into '
							   'several sub-problems and figure out how they relate. From here we can '
							   'begin solving one of the sub-problems. As we progress through this process '
							   'we should remember to always evaluate our solutions and their interaction, '
							   'and to test thoroughly and often.'}
				]
			},
			{'title': 'Lesson 5.5: Making Web Pages Look Good',
			'concepts': [
				{'title': 'Mobile-First Design',
				'description': 'Since more and more web browsing is happening on mobile devices, '
							   'it is important to design web pages with mobile in mind. Using the '
							   '@media tag in CSS we can define certain stylings to appear only on small '
							   'screens and browser windows. This can greatly enhance the mobile experience '
							   'of our page.'}
				]
			}
		]
